...
<p align="center">
	...
	<img src="https://img.shields.io/badge/VIPER-111827?style=for-the-badge&logoColor=white" alt="VIPER" />
	<img src="https://img.shields.io/badge/WebSockets-0F766E?style=for-the-badge&logo=socketdotio&logoColor=white" alt="WebSockets" />
</p>
...
<p align="center">
	...
	<img src="https://img.shields.io/badge/Scrum-009688?style=for-the-badge&logo=jira&logoColor=white" alt="Scrum" />
	<img src="https://img.shields.io/badge/Kanban-2563EB?style=for-the-badge&logo=trello&logoColor=white" alt="Kanban" />
</p>

<p align="center">
	<img src="https://img.shields.io/badge/SOLID-374151?style=for-the-badge&logoColor=white" alt="SOLID" />
...
### Practicante Auxiliar de Desarrollo de Software, Gopenux Lab S.A.S

`08/2025 – 11/2025` | Cúcuta, Norte de Santander

- Refactorización de una aplicación iOS en producción para implementar pruebas unitarias, de integración y UI.
- Desarrollo de una aplicación Android nativa desde cero, participando en diseño, implementación y pruebas.
- Desarrollo multiplataforma con Kotlin Multiplatform, compartiendo lógica de negocio entre iOS y Android.
- Consumo y validación de servicios backend mediante Postman.
- Trabajo colaborativo con GitHub bajo flujos ágiles junto a equipos de backend, QA y diseño.

### Participante de Bootcamp de Desarrollo de Software, Gopenux Lab S.A.S

`05/2025 – 08/2025` | Cúcuta, Norte de Santander

- Formación intensiva en desarrollo iOS nativo con UIKit, aplicando arquitecturas MVP y VIPER.
- Implementación de consumo de APIs REST y WebSockets para funcionalidades en tiempo real.
- Diseño de interfaces centradas en usabilidad y experiencia de usuario.
- Aplicación de principios SOLID, patrones de diseño y clean code.
- Introducción a testing, debugging, documentación técnica y metodologías ágiles.
